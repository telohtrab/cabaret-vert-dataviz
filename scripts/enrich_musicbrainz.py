...
with open('../data/performances_backup.csv', 'r', encoding='utf-8') as csvfile:
    # Load already-processed artists to avoid duplicate API calls
    try:
        with open('../data/raw/uniqueartists_backup.csv', 'r', encoding='utf-8') as buffer:
    ...
    with open('../data/raw/uniqueartists_new.csv', 'a', newline='', encoding='utf-8') as buffer:
